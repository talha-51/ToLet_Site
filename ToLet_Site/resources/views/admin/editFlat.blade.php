...
@section('mainContent')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-12">
            <h1 class="h3 mb-0 text-gray-800">Edit Flat / Villa</h1>
        </div>
        ...
        <div class="d-flex justify-content-center">
            <div class="col-lg-6">
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <h1 class="text-center text-gray-900">Edit Flat / Villa</h1>
                        <br>
                        <form class="user" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Location</label>
                                <input type="text" class="form-control" name="location" value="{{ $flat->location }}">
                                <small class="form-text  text-danger">{{ $errors->first('location') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Rent (Monthly in BDT)</label>
                                <input type="number" class="form-control" name="rent" value="{{ $flat->rent }}">
                                <small class="form-text  text-danger">{{ $errors->first('rent') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Washroom</label>
                                <input type="number" class="form-control" name="washroom" value="{{ $flat->washroom }}">
                                <small class="form-text  text-danger">{{ $errors->first('washroom') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Bed</label>
                                <input type="number" class="form-control" name="bed" value="{{ $flat->bed }}">
                                <small class="form-text  text-danger">{{ $errors->first('bed') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Dimention (In 'm' [Ex: 5*3] )</label>
                                <input type="text" class="form-control" name="dimention" value="{{ $flat->dimention }}">
                                <small class="form-text  text-danger">{{ $errors->first('dimention') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Room</label>
                                <input type="number" class="form-control" name="room" value="{{ $flat->room }}">
                                <small class="form-text  text-danger">{{ $errors->first('room') }}</small>
                            </div>
                            <div class="form-group">
                                <label>AC</label>
                                <input type="number" class="form-control" name="ac" value="{{ $flat->ac }}">
                                <small class="form-text  text-danger">{{ $errors->first('ac') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Electricity</label>
                                <select class="form-control" name="electricity" value="{{ $flat->electricity }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="phone" value="{{ $flat->phone }}">
                                <small class="form-text  text-danger">{{ $errors->first('phone') }}</small>
                            </div>
                            <div class="form-group">
                                <label>Email Address</label>
                                <input type="email" class="form-control" name="email" value="{{ $flat->email }}">
